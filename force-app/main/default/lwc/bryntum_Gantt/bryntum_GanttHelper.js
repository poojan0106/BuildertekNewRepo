  ...
  for (var i = 0; i < taskListForPhase.length; i++) {
    if (taskListForPhase[i].buildertek__Phase__c && taskPhaseRow) {
      ...
      if (taskPhaseRow["name"] != taskListForPhase[i].buildertek__Phase__c) {
        ...
        taskPhaseRow["id"] =
          taskListForPhase[i].buildertek__Schedule__c +
          "_" +
          taskListForPhase[i].buildertek__Phase__c;
      ...
      if (
        taskListForPhase[i].hasOwnProperty("buildertek__Dependency__c") == true
      ) {
        rowChilObj["predecessorName"] =
          taskListForPhase[i].buildertek__Dependency__r.Name;
      } else {
        rowChilObj["predecessorName"] = "";
      }

      rowChilObj["internalresource"] =
        taskListForPhase[i].buildertek__Resource__c;

      if (taskListForPhase[i].buildertek__Resource__c) {
        rowChilObj["internalresourcename"] =
          taskListForPhase[i].buildertek__Resource__r.Name;
      } else {
        rowChilObj["internalresourcename"] = "";
      }

      rowChilObj["contractorresource"] =
        taskListForPhase[i].buildertek__Contractor_Resource__c;

      if (taskListForPhase[i].buildertek__Contractor_Resource__c) {
        rowChilObj["contractorresourcename"] =
          taskListForPhase[i].buildertek__Contractor_Resource__r.Name;
      } else {
        rowChilObj["contractorresourcename"] = "";
      }
      rowChilObj["contractoracc"] =
        taskListForPhase[i].buildertek__Contractor__c;

      if (taskListForPhase[i].buildertek__Contractor__c) {
        rowChilObj["contractorname"] =
          taskListForPhase[i].buildertek__Contractor__r.Name; //Added for contractor
      } else {
        rowChilObj["contractorname"] = "";
      }
      ...
      if (
        taskListForPhase[i].buildertek__Lag__c != undefined &&
        taskListForPhase[i].buildertek__Lag__c != null &&
        taskListForPhase[i].buildertek__Lag__c != 0
      ) {
      ...
      if (taskListForPhase[i].buildertek__Milestone__c) {
        ...
        rowChilObj["durationMile"] =
          taskListForPhase[i].buildertek__Duration__c;
        rowChilObj["cls"] = "milestoneCompleteColor";
        rowChilObj["orgmilestone"] =
          taskListForPhase[i].buildertek__Milestone__c;
      ...
      if (taskListForPhase[i].buildertek__Dependency__c) {
        dependencyRow["id"] =
          taskListForPhase[i].Id +
          "_" +
          taskListForPhase[i].buildertek__Dependency__c;
        dependencyRow["fromTask"] =
          taskListForPhase[i].buildertek__Dependency__c;
      ...
      if (
        ...
        assignmentRow["id"] =
          ...
          "__index" +
          i +
          "ContractorResource_Name" +
          taskListForPhase[i].buildertek__Contractor_Resource__r.Name;
        assignmentRow["event"] = taskListForPhase[i].Id;
        assignmentRow["resource"] =
          taskListForPhase[i].buildertek__Contractor_Resource__c;
        assignmentRowData.push(assignmentRow);
      }
...
function saveeditRecordMethod(event, thisVal) {
  ...
  if (thisVal.newTaskRecordCreate.Name) {
    ...
    if (!isNotInsert) {
      if (thisVal.recordTaskParent) {
          ...
          addedTaskFromPlusIcon = thisVal.recordTaskParent.parent.insertChild(
            {
              ...
              startDate:
                thisVal.newTaskRecordCreate["buildertek__Start__c"] +
                "T00:00:00+05:30",
              endDate:
                thisVal.newTaskRecordCreate["buildertek__Finish__c"] +
                "T00:00:00+05:30",
              type: "Task",
              parentId:
                schId +
                "_" +
                thisVal.newTaskRecordCreate["buildertek__Phase__c"],
              percentDone:
                thisVal.newTaskRecordCreate["buildertek__Completion__c"],
              indentVal: false,
              customtype: thisVal.newTaskRecordCreate["buildertek__Type__c"],
              expanded: true,
              iconCls: "b-fa b-fa-arrow-right",
              constraintType: thisVal.newTaskRecordCreate[
        ...
        if (thisVal.recordTaskParent.type == "Phase") {
          //have same phase
          if (
            thisVal.recordTaskParent.id ==
            schId + "_" + thisVal.newTaskRecordCreate["buildertek__Phase__c"]
          ) {
            addedTaskFromPlusIcon = thisVal.recordTaskParent.insertChild(
              {
                name: thisVal.newTaskRecordCreate["Name"],
                duration:
                  thisVal.newTaskRecordCreate["buildertek__Duration__c"],
                startDate:
                  thisVal.newTaskRecordCreate["buildertek__Start__c"] +
                  "T00:00:00+05:30",
                endDate:
            ...
            if (thisVal.newTaskRecordCreate["buildertek__Dependency__c"]) {
              var dependentTask;
              if (
                thisVal.GanttVar.taskStore.getById(
                  thisVal.newTaskRecordCreate["buildertek__Dependency__c"].id
                )
              ) {
                dependentTask = thisVal.GanttVar.taskStore.getById(
                  thisVal.newTaskRecordCreate["buildertek__Dependency__c"].id
                );
              }
              var newDependencies = [
          ...
          if (!thisVal.newTaskRecordCreate["buildertek__Phase__c"]) {
            addedTaskFromPlusIcon =
              thisVal.GanttVar.taskStore.rootNode.children[0].insertChild({
                name: thisVal.newTaskRecordCreate["Name"],
                duration:
                  thisVal.newTaskRecordCreate["buildertek__Duration__c"],
                startDate:
        ...
        if (thisVal.recordTaskParent.type == "Project") {
          if (thisVal.newTaskRecordCreate["buildertek__Phase__c"]) {
            ...
            if (
              ...
              phaseParent = thisVal.GanttVar.taskStore.getById(
                schId +
                  "_" +
                  thisVal.newTaskRecordCreate["buildertek__Phase__c"]
              );
              ...
              phaseParent =
                thisVal.GanttVar.taskStore.rootNode.children[0].insertChild({
                  ...
                  indentVal: false,
                  customtype:
                    thisVal.newTaskRecordCreate["buildertek__Type__c"],
                  expanded: true,
                  iconCls: "",
                  constraintType: thisVal.newTaskRecordCreate[
                    "buildertek__Dependency__c"
          ...
          addedTaskFromPlusIcon =
            thisVal.GanttVar.taskStore.rootNode.children[0].insertChild({
              ...
              endDate:
                ...
                "T00:00:00+05:30",
              type: "Task",
              parentId: thisVal.newTaskRecordCreate["buildertek__Phase__c"]
                ? schId +
                  "_" +
                  thisVal.newTaskRecordCreate["buildertek__Phase__c"]
                : schId,
    ...
    insertUpdateTask({
      taskFields: JSON.stringify(thisVal.newTaskRecordCreate),
  ...
  if (thisVal.newTaskRecordCreate["buildertek__Phase__c"]) {
    ...
    if (
      ...
      addedTaskFromPlusIcon = phaseParent.insertChild({
        ...
        expanded: true,
        iconCls: "b-fa b-fa-arrow-right",
        constraintType: thisVal.newTaskRecordCreate["buildertek__Dependency__c"]
          ? ""
          : "startnoearlierthan",
      });
    } else {
...
function customInsertTaskMethod(schId, thisVal, dependentTask) {
  var addedTaskFromPlusIcon = dependentTask.insertChild({
    ...
    duration: thisVal.newTaskRecordCreate["buildertek__Duration__c"],
    startDate:
      thisVal.newTaskRecordCreate["buildertek__Start__c"] + "T00:00:00+05:30",
    endDate:
      thisVal.newTaskRecordCreate["buildertek__Finish__c"] + "T00:00:00+05:30",
    type: "Task",
