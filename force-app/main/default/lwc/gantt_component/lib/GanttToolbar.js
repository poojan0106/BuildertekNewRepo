...
export default (base) =>
  class GanttToolbar extends base {
    ...
    async onAddTaskClick() {
        const { gantt } = this,
        added = gantt.taskStore.rootNode.children[0].appendChild({
          name: "New task",
          duration: 1,
          startDate: gantt.taskStore.rootNode.children[0].startDate
        });
    ...
    onSaveClick() {
      try {
        ...
        let dataForApexController = convertJSONtoApexData(
          data,
          taskData,
          dependenciesData,
          resourceData
        ...
        this.gantt.callGanttComponent.saveChanges(
          dataForApexController.scheduleData,
          dataForApexController.taskData
        );
      } catch (error) {
