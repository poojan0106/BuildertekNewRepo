...
import getRelatedFiles from '@salesforce/apex/previewFileController.getRelatedFiles';
...
export default class PreviewFiles extends NavigationMixin(LightningElement) {
    // reactive variables
    @api files;
    @api recIdList;
